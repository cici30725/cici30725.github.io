...
<div class="flex flex-col items-center my-10 py-5 gap-y-5">
	...
	<div class="font-serif">
		<div>
			Email: <a href="mailto:hsuhsikang@gmail.com" class="underline underline-offset-2"
				>hsuhsikang@gmail.com</a
			>
		</div>
		<div>
			Github: <a href="https://github.com/cici30725" class="underline underline-offset-2"
				>github.com/cici30725</a
			>
		</div>
	</div>
	<div class="max-w-xl">
		<p>
			I recently graduated from National Taiwan University with a master's degree in computer
			science. I wrote my thesis on efficient methods for pricing interest rate derivatives with the
